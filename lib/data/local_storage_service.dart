...
class LocalStorageService {
  ...
  static const _hydrationKey = 'hydration_v1';
  ...
  Future<Map<String, dynamic>?> loadHydrationData() async {
    final prefs = await SharedPreferences.getInstance();
  ...
  Future<void> saveHydrationData(Map<String, dynamic> hydrationData) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString(_hydrationKey, jsonEncode(hydrationData));
  }
}
